...
import { S as Subscribable, s as shallowEqualObjects, h as hashKey, g as getDefaultState, n as notifyManager, e as useQueryClient, r as reactExports, f as noop, i as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, k as cn, l as useIsAdmin, u as useBackend, m as useQuery } from "./index-B7nc54-L.js";
import { B as Badge } from "./badge-H9ft0Z69.js";
import { B as Button } from "./button-DkDFYC-c.js";
import { P as Primitive, L as Label, I as Input, u as ue } from "./index-jZut3nIP.js";
import { C as CircleX } from "./circle-x-DDMG90AO.js";
import { L as LoaderCircle } from "./loader-circle-C56G2HKw.js";
import { T as Twitter } from "./twitter-mqjJNsCa.js";
...
function CanisterStatePanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Terminal, { className: "w-5 h-5 mt-0.5 text-primary flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold text-foreground", children: "Canister State" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Live debug snapshot. Refreshes every 5 seconds." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-border/60" }),
    ...
    "main",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 items-start", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CanisterStatePanel, {}) })
        ] })
      ]
    }
  );
